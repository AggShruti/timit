...
set noxtics
set noytics
set title 'DET plot for exp/sgmm2_4_mmi_b0.1/decode_dev_it3/score_9/ctm_39phn.filt'
set nokey
...
plot [-3.290527:3.290527] [-3.290527:3.290527] \
 "exp/sgmm2_4_mmi_b0.1/decode_dev_it3/score_9/ctm_39phn.filt.det.dat.00" using 2:1 title "exp/sgmm2_4_mmi_b0.1/decode_dev_it3/score_9/ctm_39phn" with lines 1
set ytics
set xtics
set size 1.0, 1.0
set key
